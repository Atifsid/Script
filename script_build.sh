...
git config --global user.email "atifsiddiqui35@gmail.com"
git config --global user.name "Atifsid"
sudo apt install jq 
...
export BOT_API_KEY="enter tg bot api token here"
export CHAT_ID="enter your tg chatid here";
...
message="CI build of QuantumX Kernel completed with the latest commit."
